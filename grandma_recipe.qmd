...
within a nested level and different ones between).  

Hey! did you notice the backticks (upper left of your keyboard---
...
color).  Super useful for variable names or functions like
`x_data` or `y_data`.
...
given similar work done on cooking times of _Cassiopea_ jellies at altitude
[@sharp2022] and for _Orbicella_ with different microbiomes [@boville2023].
But please bear in mind that we did not account for the issues noted by
@gonzalez-pech2021 which arise while using next generation oven technology.
...
If you use [Zotero](https://zotero.org) as your citation manager, 
you can set it up to maintain a
bibliography in your repository based on a collection (folder) in Zotero. Every
time you add a citation to the collection, Zotero will automagically write it
to the .bib file!!
...
By including `docx:` and `pdf:` in the YAML header, a little arrow appears next
...
*Render* and choose "Render Word".  Can you figure out what
